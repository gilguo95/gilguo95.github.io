...
.btn-default {
  ...
  background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #161616), color-stop(100%, #161616));
  background-image: -webkit-linear-gradient(top, #161616 0%, #161616 100%);
  background-image: linear-gradient(to bottom, #161616 0%, #1616161 100%);
}
.btn-default:active {
...
.toolbar {
  ...
  background-color: #191919;
  background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #191919), color-stop(100%, #191919));
  background-image: -webkit-linear-gradient(top, #191919 0%, #191919 100%);
...
.toolbar-header {
  border-bottom: 0px solid #c2c0c2;
}
...
.tab-group {
  margin-top: -0px;
  display: flex;
  border-top: 0px solid #989698;
  border-bottom: 0px solid #989698;
}
...
.tab-item {
  ...
  background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #fff), color-stop(100%, #b0aeb0));
